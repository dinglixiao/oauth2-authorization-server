...
import com.bsp.oauth2.authorization.server.configuration.federated.identity.FederatedIdentityConfigurer;
import com.bsp.oauth2.authorization.server.configuration.jose.Jwks;
import com.bsp.oauth2.authorization.server.entity.UserAuthority;
import com.bsp.oauth2.authorization.server.jackson2.mixin.LongMixin;
import com.bsp.oauth2.authorization.server.jackson2.mixin.UserAuthorityMixin;
import com.bsp.oauth2.authorization.server.jackson2.mixin.UserPrincipalMixin;
import com.bsp.oauth2.authorization.server.entity.UserPrincipal;
import com.bsp.oauth2.authorization.server.oauth2.authentication.OAuth2ResourceOwnerPasswordAuthenticationConverter;
import com.bsp.oauth2.authorization.server.oauth2.authentication.OAuth2ResourceOwnerPasswordAuthenticationProvider;
...
import com.bsp.oauth2.authorization.server.oauth2.customizer.jwt.impl.JwtCustomizerImpl;
import com.bsp.oauth2.authorization.server.oauth2.customizer.token.claims.OAuth2TokenClaimsCustomizer;
import com.bsp.oauth2.authorization.server.oauth2.customizer.token.claims.impl.OAuth2TokenClaimsCustomizerImpl;
