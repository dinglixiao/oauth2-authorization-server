...
import com.example.oauth2.authorization.server.oauth2.authentication.OAuth2ResourceOwnerPasswordAuthenticationProvider;
import com.example.oauth2.authorization.server.oauth2.customizer.jwt.JwtCustomizer;
import com.example.oauth2.authorization.server.oauth2.customizer.jwt.JwtCustomizerHandler;
import com.example.oauth2.authorization.server.oauth2.customizer.jwt.impl.JwtCustomizerImpl;
import com.example.oauth2.authorization.server.oauth2.customizer.token.claims.OAuth2TokenClaimsCustomizer;
import com.example.oauth2.authorization.server.oauth2.customizer.token.claims.impl.OAuth2TokenClaimsCustomizerImpl;
