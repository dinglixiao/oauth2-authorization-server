package com.example.oauth2.authorization.server.configuration.federated.identity;
...
public final class FederatedIdentityConfigurer extends AbstractHttpConfigurer<FederatedIdentityConfigurer, HttpSecurity> {
	 ...
	 * the login flow with an external IDP, defaults to {@code "/oauth2/authorization/{registrationId}"}
	 * @return This configurer for additional configuration
	 */
	...
	/**
	 * @param oauth2UserHandler The {@link Consumer} for performing JIT account provisioning with an OAuth 2.0 IDP
	 * @return This configurer for additional configuration
	 */
	...
	/**
	 * @param oidcUserHandler The {@link Consumer} for performing JIT account provisioning with an OpenID Connect 1.0 IDP
	 * @return This configurer for additional configuration
	 */
